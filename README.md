...
1. Trained each currency pair, and stored the optimized regression models. The models performance wasn't optimum may due to small amount of training data, 400 data after cleaning and aggregation. According to The Law of Large Numbers, if we only have a few experiments, it's very possible that our experimental probability could be different than our theoretical probility. I proceeded the modeling steps presented in [Trailing Stops 2](./detail_descriptions/Trailing%20Stops%202.pdf).
