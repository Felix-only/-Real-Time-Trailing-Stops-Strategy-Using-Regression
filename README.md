...
For details of codes, Checked out [README.MD](https://github.com/Felix-only/Real-Time-Trailing-Stops-Strategy-Using-Regression/notebooks/README.md) in the **notebooks folder**.
